...
<!-- Self-hosted SVG knowledge-graph (generated by scripts/work-graph.mjs) of how
     ...
     as does manwe (UAV detection); cortexel connects to engram. The NCP links render as live,
