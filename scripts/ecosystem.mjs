...
export const LOCAL_NCP = {
  ...
  composition: "NCP is project-neutral. Applications select their peers and typed contracts. One producer can expose several sensors through one endpoint. CREBAIN runs standalone; Prisoma capture, Engram neural models, and Galadriel monitoring are separate choices. Future systems can define their own application contracts without adding project-specific behavior to NCP.",
