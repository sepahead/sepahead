...
export const LOCAL_NCP = {
  ...
  sensors: "The first planned embodied PID case uses RGB and acoustic observations, with thermal optional. Two cameras or microphones remain distinct sensor instances, even when they share a modality. Prisoma defines their feature encoding, source grouping, timing, target, and statistical assumptions. PID-rs estimates the declared quantities. Two through four source variables are the initial experiment scope, not an NCP limit. Radar and other robotics sensors need their own typed contracts and producer validation.",
