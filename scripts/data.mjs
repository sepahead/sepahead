...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Auditable capture-intervention-replay experiments for vision-language-action policy diagnosis. PID stays behind explicit validation gates.",
    stack: ["Rust", "Python"],
  ...
  },
  {
    ...
    stars: 18, repo: "sepahead/crebain",
    desc: "Research-only Tauri/Rust prototype: Gaussian-splat scenes, ML detection, multimodal 3D tracking and ROS/Gazebo drone simulation.",
    stack: ["TS", "Rust", "Nix"],
  ...
  },
  {
    ...
    desc: "Deterministic 3D Gaussian-splat toolkit: inspect, convert, complete and view PLY, SPZ and glTF scenes; CPU/Metal, optional CUDA.",
  ...
  },
  {
    ...
    desc: "Strict JSON contracts for neural-simulation figures, rendered as deterministic accessible SVG with exact-value tables and provenance.",
    stack: ["TS", "SVG", "JSON"],
  ...
  // star count — they are the same repos rendered as dataset chips in the graph).
  {
    ...
    desc: "Python pipeline and 10,079 AI-generated GLB meshes for disaster relief, humanitarian aid and civil protection; licensing per asset.",
    stack: ["Python"],
