...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Tests action-conditioned forecasts and decisions for embodied agents. Controlled environment forks and replay remain under qualification.",
    stack: ["Rust", "Python"],
    summary: "Prisoma develops controlled experiments for action-conditioned world models and embodied agents. Its experiment design compares candidate actions from the same saved environment state, commits forecasts before outcomes, executes the selected action, and evaluates alternatives on independent branches. It records the evidence needed to check whether forecasts improve decisions over simpler baselines. CREBAIN supplies the proposed 3D environment adapter; Rerun export supports visualization. A deterministic experiment reference and NCP capture are implemented. Learned-model qualification and CREBAIN-backed forks remain open. PID is an optional diagnostic with separate validity requirements.",
