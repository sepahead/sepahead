...
export const PROJECTS = [
  {
    ...
    stack: ["AI Agent", "NEST"],
    summary: "Engram experiments use biophysical and functional neural models. An AI agent and custom harness track model sources, simulation inputs, and results. Its optional NCP controller matched direct NEST readouts in a CREBAIN loop. The public repository remains a placeholder pending source publication. Private Paper2Brain source does not claim general paper reproduction or validated scientific results.",
    status: "Research prototype. Public source remains a placeholder. Bounded software checks do not establish scientific validity.",
  ...
  },
  {
    ...
    stack: ["TS", "Rust", "Nix"],
    summary: "CREBAIN provides standalone drone simulation with RGB images, microphone pressure, thermal radiance, and optional NCP interfaces. Native checkpoint controls passed with 3 and 16 endpoints. City tests exercised 256 drones through NCP. Tracking qualification remains open. Physical realism and learned-policy quality are not established.",
