...
export const PROJECTS = [
  ...
  },
  {
    ...
    summary: "Neuro-Cybernetic Protocol (NCP) defines typed messages for neural controllers, simulations, sensor monitors, and experiment capture. Its local v1 adapters connect Engram, CREBAIN, Galadriel, and Prisoma through private process channels. NCP is a protocol, not a central runtime or a mandatory all-project bundle. Independent adapter qualification and final release gates remain open. Haldir uses the separate pinned v0.8 interface.",
    status: "Local v1 simulation candidate; installed-artifact qualification and final release gates remain open.",
  ...
  },
  {
    ...
    headline: "Sensor-tampering monitor",
    accent: "#ef4444", light: "#dc2626", grad: "#2a0a0a",
    stars: 3, repo: "sepahead/galadriel",
    desc: "Flags suspicious sensor inconsistencies and persistent anomalies. Reports insufficient evidence; alarms grant no command authority.",
    stack: ["Rust"],
    summary: "Galadriel is a Rust monitor for possible sensor tampering and persistent measurement anomalies. It checks prediction residuals, changes over time, and agreement between sensor modalities. An alert identifies suspicious evidence; it does not establish an attack's cause. Its NCP adapter records assessments without command authority. The current single-Visual integration test correctly reports insufficient evidence; multisensor tampering qualification and field validation remain open.",
