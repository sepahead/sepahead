...
export const PROJECTS = [
  {
    ...
    desc: "Engram Neural Modeling Labs, the hub: spiking-network and neural-modeling experiments that drive the rest of the stack.",
  ...
  },
  {
    ...
    desc: "Partial Information Decomposition with continuous mutual-information (KSG / I_sx) estimators, in safe Rust. The estimator core.",
    stack: ["Rust"],
  },
  {
    name: "cortexel",
